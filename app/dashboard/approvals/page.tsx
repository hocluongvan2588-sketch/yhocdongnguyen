...
export default function ApprovalsPage() {
    ...
    return (
      <div className="container mx-auto p-6">
        <div className="text-center py-12">
          ...
          <p className="text-slate-400">Đang tải danh sách phê duyệt...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div>
        <h1 className="text-4xl font-bold text-white mb-2">Quản Lý Phê Duyệt</h1>
        <p className="text-slate-400">Xét duyệt các hoạt động quan trọng trong hệ thống</p>
      </div>

      <div className="grid gap-4 md:grid-cols-4">
        <Card className="glass-strong border-amber-500/30">
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium text-slate-400">Tổng Chờ Duyệt</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="glass-strong border-red-500/30">
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium text-slate-400">Khẩn Cấp</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="glass-strong border-blue-500/30">
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium text-slate-400">Chuyển Đổi</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="glass-strong border-emerald-500/30">
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium text-slate-400">Vận Chuyển</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>{filteredApprovals.length} mục cần xử lý</CardDescription>
            </div>
        ...
        <CardContent>
          {filteredApprovals.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-slate-400 text-lg">Không có mục nào cần phê duyệt</p>
              <p className="text-slate-500 text-sm mt-2">Tất cả hoạt động đã được xử lý</p>
            </div>
          ) : (
                      ...
                      <div className="flex items-start gap-4 flex-1">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="grid grid-cols-2 gap-4 mt-3 text-sm">
                            ...
                            <div>
                              <p className="text-slate-500">Thời gian chờ</p>
                              <p className="text-slate-300 font-medium">{Math.round(approval.hours_pending)} giờ</p>
                            </div>
                          </div>
                          {approval.details && (
                            <div className="mt-3">
                              <p className="text-slate-500 text-sm">Chi tiết</p>
      ...
      <Dialog open={showRejectDialog} onOpenChange={setShowRejectDialog}>
        <DialogContent className="glass-strong border-white/10">
          <DialogHeader>
            ...
            <DialogDescription>Vui lòng nhập lý do từ chối để thông báo cho người tạo</DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <div>
              ...
              <Textarea
                ...
                placeholder="Ví dụ: Thông tin không đầy đủ, cần xác nhận lại số lượng..."
